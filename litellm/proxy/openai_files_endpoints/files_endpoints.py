...
async def create_file(
    ...
    try:
        ...
        scan_result: BatchScanResult | None = None  # rebind-ok: set only when the scan runs
        if (
            purpose == "batch"
            ...
            scan_result = outcome
            if scan_result.changes and scan_result.submitted_records == 0:
                raise_nothing_to_submit()
        ...
        upload_source: Final = (
            rewrite_batch_input_file(file_source, scan_result)
